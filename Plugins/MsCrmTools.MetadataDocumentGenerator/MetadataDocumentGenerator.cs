...
namespace MsCrmTools.MetadataDocumentGenerator
{
    [Export(typeof(IMsCrmToolsPluginUserControl)),
       ExportMetadata("Name", "Metadata Document Generator"),
       ExportMetadata("Description", "A tool to generate Excel and Word document with entities and attributes information"),
    ...
    public partial class MetadataDocumentGenerator : PluginBase
    {
        #region Variables
