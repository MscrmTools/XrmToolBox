...
namespace MsCrmTools.FormLibrariesManager
{
    [Export(typeof(IMsCrmToolsPluginUserControl)),
      ExportMetadata("Name", "Form Libraries Manager"),
      ExportMetadata("Description", "This tool helps you to add/remove mutliple JavaScript libraries to multiple forms"),
