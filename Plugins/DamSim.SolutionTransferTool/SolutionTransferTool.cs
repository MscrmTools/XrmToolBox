...
namespace DamSim.SolutionTransferTool
{
    ...
    ExportMetadata("Name", "Solution Transfer Tool"),
    ExportMetadata("Description", "Transfer a solution from a source organization to a target organization")]
