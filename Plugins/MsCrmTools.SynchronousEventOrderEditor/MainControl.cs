...
namespace MsCrmTools.SynchronousEventOrderEditor
{
    [Export(typeof(IMsCrmToolsPluginUserControl)),
       ExportMetadata("Name", "Synchronous events execution order editor"),
       ExportMetadata("Description", "This tool helps you to manage execution order of synchronous events (Workflow and plugins)"),
