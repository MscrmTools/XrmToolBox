...
{
    [Export(typeof(IXrmToolBoxPluginControl)),
       ExportMetadata("Name", "User Roles Manager"),
       ExportMetadata("Description", "Allows to edit user/team and roles association in bulk"),
    ...
    public partial class MainControl : PluginControlBase
    {
        ...
        private void action3ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            WorkAsync("Removing roles from principal(s)...",
              (bw, evt) =>
              {
                  var action = (RoleAction)evt.Argument;
