...
namespace MsCrmTools.SolutionComponentsMover
{
    public partial class MainControl : UserControl, IMsCrmToolsPluginUserControl
    {
        ...
        {
            infoPanel = InformationPanel.GetInformationPanel(this, "Loading solutions...", 340, 150);
        ...
        private void tsbCopyComponents_Click(object sender, EventArgs e)
        {
            ...
            infoPanel = InformationPanel.GetInformationPanel(this, "Starting copy...", 340, 150);
            
            var copyWorker = new BackgroundWorker { WorkerReportsProgress = true };
            ...
            copyWorker.RunWorkerAsync(settings);
        }

        void copyWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            var settings = (CopySettings)e.Argument;
            sManager.CopyComponents(settings, (BackgroundWorker)sender);
        }

        void copyWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
