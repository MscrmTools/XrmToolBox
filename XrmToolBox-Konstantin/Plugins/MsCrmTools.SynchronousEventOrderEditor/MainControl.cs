...
namespace MsCrmTools.SynchronousEventOrderEditor
{
    ...
    public partial class MainControl : UserControl, IMsCrmToolsPluginUserControl
    {
        ...
        public void UpdateConnection(IOrganizationService newService, ConnectionDetail connectionDetail, string actionName = "", object parameter = null)
        {
            ...
            {
                throw new Exception("This plugin is only designed for Microsoft Dynamics CRM 2013 and above");
            }
        ...
        private void tsbLoadEvents_Click(object sender, EventArgs e)
        {
            if (service == null)
            {
                OnRequestConnection(this, new RequestConnectionEventArgs {ActionName = "loadevents", Control = this});
            }
            else
            {
                LoadEvents();
        ...
        private void LoadEvents()
        {
            ...
            infoPanel = InformationPanel.GetInformationPanel(this, "Loading Sdk message filters...", 340, 150);
        ...
        private void tvEvents_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            var events = (List<ISynchronousEvent>) e.Node.Tag;
        ...
        private void tsbUpdate_Click(object sender, EventArgs e)
        {
            ...
            infoPanel = InformationPanel.GetInformationPanel(this, "Updating...", 340, 150);

            var bwUpdate = new BackgroundWorker {WorkerReportsProgress = true};
            bwUpdate.DoWork += bwUpdate_DoWork;
            bwUpdate.ProgressChanged += bwUpdate_ProgressChanged;
